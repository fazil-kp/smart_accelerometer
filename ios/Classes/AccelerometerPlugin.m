...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    ...
    [FlutterEventChannel eventChannelWithName:@"fazi.com/accelerometer_sensor/user_accel"
                              binaryMessenger:[registrar messenger]];
    ...
    [FlutterEventChannel eventChannelWithName:@"fazi.com/accelerometer_sensor/gyroscope"
                              binaryMessenger:[registrar messenger]];
    ...
    [FlutterEventChannel eventChannelWithName:@"fazi.com/accelerometer_sensor/proximity"
                              binaryMessenger:[registrar messenger]];
